...
def process_merged_line(line, chrom, dup_set):
    ...
    # Else-if there is no alternative allele.
        ...
        return None, '\t'.join([str(chrom), str(pos), arc_qc[0], arc_qc[1], arc_qc[2], arc_qc[3], '0', 'arc_ref'])+'\n', None
    ...
    # Else-if the site is bi-allelic.
        ...
        return None, '\t'.join([str(chrom), str(pos), arc_qc[0], arc_qc[1], arc_qc[2], arc_qc[3], '1', 'arc_var'])+'\n', '\t'.join(spline)+'\n'
