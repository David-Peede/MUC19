...
def arc_eff_seq_len(vcf, chrom):
    ...
    qc_file = open('./vcf_bookkeeping/all_archaics_merged_all_sites_qc/chr{0}_qc_report.txt'.format(chrom), 'w')
    sites_file = open('./vcf_bookkeeping/all_archaics_merged_all_sites_qc/chr{0}_all_sites_report.txt'.format(chrom), 'w')
...
arc_eff_seq_len(vcf=str(sys.argv[1]), chrom=str(sys.argv[2]))