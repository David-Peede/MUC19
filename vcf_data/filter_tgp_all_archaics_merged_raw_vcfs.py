...
def tgp_all_archaics_merged_raw_vcf(vcf, chrom):
    """
    ###########################################################################
    INPUT
    ...
    qc_file = open('./vcf_bookkeeping/tgp_all_archaics_merged_raw_qc/chr{0}_qc_report.txt'.format(chrom), 'w')
...
tgp_all_archaics_merged_raw_vcf(vcf=str(sys.argv[1]), chrom=str(sys.argv[2]))