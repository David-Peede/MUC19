...
def arc_het_windows(chromosome, window_size):
    ...
    results_file = 'arc_het_counts_chr{0}_{1}kb.csv.gz'.format(chromosome, window_size)
...
arc_het_windows(chromosome=int(sys.argv[1]), window_size=int(sys.argv[2]))
